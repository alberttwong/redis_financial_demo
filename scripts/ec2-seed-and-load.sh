...
MEMTIER_TRANSACTION_RATE_PER_CONNECTION="${MEMTIER_TRANSACTION_RATE_PER_CONNECTION:-750}" \
MEMTIER_TRADE_RATE_PER_CONNECTION="${MEMTIER_TRADE_RATE_PER_CONNECTION:-150}" \
