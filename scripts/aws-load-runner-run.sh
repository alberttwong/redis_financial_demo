...
ssh "${SSH_OPTS[@]}" "${SSH_USER}@${HOST}" \
  "cd '${REMOTE_DIR}' && \
   ...
   MEMTIER_CLIENTS='${MEMTIER_CLIENTS:-50}' \
   MEMTIER_PIPELINE='${MEMTIER_PIPELINE:-16}' \
   MEMTIER_TRANSACTION_RATE_PER_CONNECTION='${MEMTIER_TRANSACTION_RATE_PER_CONNECTION:-900}' \
   MEMTIER_TRADE_RATE_PER_CONNECTION='${MEMTIER_TRADE_RATE_PER_CONNECTION:-${MEMTIER_TRANSACTION_RATE_PER_CONNECTION:-300}}' \
